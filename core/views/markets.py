...
@app.get(
    "/markets/",
    response_description="List of all markets",
    response_model=List[MarketModel],
)
...
@app.post(
    "/markets/", response_description="Add new market", response_model=MarketModel
)
...
@app.put(
    "/markets/{id}", response_description="Update a market", response_model=MarketModel
)
